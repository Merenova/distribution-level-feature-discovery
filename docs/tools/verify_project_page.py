...
def main():
    ...
    required_reader_copy = [
        ...
        "<strong>Implication:</strong> KM-Sem's failure suggests that semantic grouping alone does not recover causally useful feature directions, while Single's weaker transfer shows that one continuation can miss the cluster-level mechanism. RD succeeds because its medoid is chosen from a group aligned in both semantic and mechanistic views.",
