#!/usr/bin/env bash
# Sweep script for Gemma-3-4B experiments
...
BASE_CONFIG="configs/gemma3_4b_config.json"
BASE_OUTPUT_DIR="Gemma3_4B_results"
...
echo "========================================"
echo "GEMMA3-4B PARAMETER SWEEP"
echo "========================================"
...
" 2>/dev/null
  ...
  bash run_pipeline.sh --output_dir "$OUTPUT_DIR" --resume 5 --quiet
